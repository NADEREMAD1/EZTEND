  ...
  <footer class="footer">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6">
            <div class="footer-widget">
              <div class="logo mb-30">
                <a href="index.html">
                  <img src="assets/img/logo/logo.png" class="w-100" alt="" />
                </a>
              </div>
          ...
          <div class="col-xl-3 col-lg-3 col-md-6">
            <div class="footer-widget">
              ...
              <ul class="links">
                ...
                <li><a href="./Refund_Policy.php">Return and Refund Policy</a></li>
    ...
    <div class="row">
      <div class="col-6 col-lg-6 col-md-6">
        <form action="#" class="subscribe-form m-2 d-flex w-75 ms-auto">
          <input type="email" name="subs-email" id="subs-email" placeholder="Your Email" class="form-control" />
          <button type="submit" class="btn-hover btn btn-danger">
            Subscribe
          </button>
        </form>
      </div>
